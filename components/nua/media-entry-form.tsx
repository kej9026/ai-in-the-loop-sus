...
export function MediaEntryForm({ onCancel, onSuccess }: MediaEntryFormProps) {
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                    {generatedTags.length > 0 ? generatedTags.map((tag) => (
                                        <Badge
                                            key={tag}
                                            variant="secondary"
                                            className="text-sm font-medium px-3 py-1 bg-neon-purple/20 text-neon-purple border-neon-purple/50 shadow-[0_0_10px_rgba(168,85,247,0.2)]"
                                            style={aiThemeColor ? {
                                                backgroundColor: aiThemeColor + '30', // More opaque background
                                                color: '#ffffff', // White text for better contrast on colored bg
                                                borderColor: aiThemeColor,
                                                textShadow: `0 0 5px ${aiThemeColor}`
                                            } : undefined}
                                        >
                                            #{tag}
                                        </Badge>
                    ...
                    onClick={async () => {
                        ...
                        try {
                            ...
                            const newItem: MediaItem = {
                                id: "new",
                                mediaId: "", // Placeholder, will be handled by createPost
